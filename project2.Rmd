...
The models we built included the week variables (Linear Model 1), all variables (Linear Model 2), and the ones we found to have some very slight relationship with (Linear Model 3). We also performed two boosted models with all variables and again the same variables inside Linear Model 3, but was not as effective as our 2nd Linear Model.
