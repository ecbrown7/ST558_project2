...
Here, we'll get started by reading in Online News Popularity data and subsetting by news category (news channel). Additionally, URL and timedelta  (columns 1 and 2) are non-predictive variables. As such, we'll remove them from the main data set to create a data set to model on later on.
