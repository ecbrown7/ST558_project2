...
After reading the data in and sub-setting by news category, the first thing we'll look at is some basic summary statistics of the data set for each category. These summaries will include a minimum, median (less sensitive to outliers), mean, max and 98th quantile. Since we care about predicting shares of future articles, some outliers may skew our what the majority of our data look like. As such, we'll look at the 98th quantile and take this as a representative number of the *majority* of the data. 
